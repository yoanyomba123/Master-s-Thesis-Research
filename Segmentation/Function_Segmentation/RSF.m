...
% Modified by Pengwei Wu
% Implements the level set evolution (LSE) for the method in Chunming Li et al's paper:
...
% Another way of doing it, although not quicker
% c1 = conv2fft(Hu,Ksigma);
% c2 = conv2fft(I,Ksigma);
